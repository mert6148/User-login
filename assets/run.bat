...
if not exist compiler.py (
    ...
    echo output_path = r"C:\Users\mertd\OneDrive\Masaüstü\Kullanıcı girişi\print.py">>compiler.py
...
if not exist "C:\Users\mertd\OneDrive\Masaüstü\Kullanıcı girişi\print.py" (
